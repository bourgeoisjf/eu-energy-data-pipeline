...
4. Writes a new enriched CSV without overwriting previous pipeline outputs

This follows a production-style ETL approach:
- Each step reads from the previous layer
- Each step produces a new, traceable output
"""
